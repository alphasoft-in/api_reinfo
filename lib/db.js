    ...
    try {
        ...
        if (parseInt(planesCount[0].count) === 0) {
            await sql`
                ...
                ('Professional', '49', '10000', '{"10k Consultas RUC", "Exportación Excel/CSV", "API Key dedicada", "Soporte prioritario"}'),
                ('Enterprise', '199', '1000000', '{"Consultas Ilimitadas*", "Conexión Directa DB", "Analítica avanzada", "SLA 99.9%", "Manager dedicado"}')
            `;
        }
